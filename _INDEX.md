...
_Atualizado em: 2026-07-29 (sessão 9)_
...
- **Publicado:** raiz do GitHub Pages segue servindo o protótipo VeredaTech (links antigos intactos) e a versão da Câmara vai em **`/aracaju/`** — https://cinthiasouza.github.io/veredatech/aracaju/ · tela de parlamentares em `/aracaju/6.8-parlamentares.html`.
...
| 2026-07-29 | Versão white-label com a **identidade visual da Câmara de Aracaju** em `04-execucao/prototipo-aracaju/` (paleta oficial + brasão; header/hero/botões deixaram de ser preto e passaram aos azuis abertos da Casa, em 2 rodadas — a 1ª ficou insuficiente). Nova tela **6.8 Parlamentares** no perfil Secretaria/Presidência com os **26 vereadores reais** (nomes, partidos e fotos oficiais, extraídos via browser do iframe `leg.cmaju.com.br`) e a quantidade de proposições por parlamentar — **números simulados, com aviso destacado na tela**. Base `styles/vereadores.js` reescrita (era amostra de 10 fictícios). Pages passa a servir raiz = VeredaTech + `/aracaju/`. Commits `0c8ed21`, `9ba27e0`, `749d071`, `c8824d6` publicados. | `04-execucao/_logs/2026-07-29_identidade-camara-aracaju-e-parlamentares.md` |
